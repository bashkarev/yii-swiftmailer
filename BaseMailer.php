...
abstract class BaseMailer extends \CComponent implements MailerInterface
{
     ...
     */
    public $messageClass = 'bashkarev\swiftmailer\BaseMessage';
    /**
    ...
    /**
     * @var \bashkarev\swiftmailer\View|array view instance or its array configuration.
     */
    private $_view = [];
    ...
    protected function createView(array $config)
    {
        if (!array_key_exists('class', $config)) {
            $config['class'] = 'bashkarev\swiftmailer\View';
        }
